...
public class Edificio {
	 ...
	 */
	public void reparar(Posicion pos) throws FinDeNivelException, FinDeSeccionException{
	 ...
	 * @throws FinDeSeccionException 
	 */	
	private void avanzarSeccion() throws FinDeNivelException, FinDeSeccionException {
		seccionActual++;
	...
	public void reiniciarSeccion() {
		Model.getModel().reiniciarEntidades();
		Dificultad dif = Model.getModel().dificultadActual();
	 ...
	 * @see Seccion#nuevaPosicion(Posicion, Direccion)
	 * @see Ventana#hayObstaculo(Direccion)
	 */
	public Posicion nuevaPosicion(Posicion posActual, Direccion dir) {
		Posicion posNueva = new Posicion(secciones[seccionActual].nuevaPosicion(posActual, dir));
		return posNueva;	
	}
	 ...
	 * con el {@link Panel} inferior <kbd>TODOROTO</kbd>, En caso de haber mas de una, elije una aleatoria.
	...
	public Seccion getSeccion() {
		return secciones[seccionActual];
	}
